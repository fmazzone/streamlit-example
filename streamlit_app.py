...
title = '<p style="font-family:courier; color:#fcfcfc; font-size: 42px; font-weight: bold; font-style: italic;"> Weather Forecast</p>'
...
window_selection_c.markdown("## Dati")  # add a title to the sidebar container
